...
void Main()
{
    ...
    hook::user_status();
    hook::world_thread();
    hook::dynamic_drop(); // Activado - ahora incluye validación BossParty
    hook::packet_chat();
    // hook::boss_party_validator(); // No necesario - está integrado en dynamic_drop
